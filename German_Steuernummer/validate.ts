...
import { BZST_IDNR_SOURCE, SYNTHETIC_STEUERNUMMER_WARNING } from "../steuernummer/types.ts";
import { calculateSteuerIdCheckDigit, passesSteuerIdRepetitionRule } from "./checksum.ts";
